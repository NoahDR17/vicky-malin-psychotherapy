...
const Online = () => {
    return (
        <Container className="online-services my-5">
            ...
            <section className="service-platform mb-5">
                <div className="section-card">
                    <h3 className="text-center mb-3">Online & Telephone Counselling</h3>
                    <p className="platform-description text-center mb-4">
            ...
            <section className="service-description mb-5">
                <div className="section-card">
                    <h3 className="mb-3">Effective Online & Telephone Counselling</h3>
                    <p className="mb-4">
