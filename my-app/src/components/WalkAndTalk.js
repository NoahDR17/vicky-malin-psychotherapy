...
const WalkAndTalk = () => {
  return (
    <Container className="walk-and-talk my-5">
      ...
      <section className="service-intro mb-5">
        <div className="section-card">
          <h3 className="text-center mb-3">Walk and Talk Therapy (Ecotherapy)</h3>
      ...
      {/* Photo Section
      <section className="service-photo mb-5">
        <div className="section-card">
      ...
      <section className="service-description mb-5">
        <div className="section-card">
          <h3 className="mb-3">What is Walk and Talk Therapy?</h3>
          <p className="mb-4">
      ...
      {/* Coming Soon Section */}
      <section className="coming-soon mb-5">
        <div className="section-card">
